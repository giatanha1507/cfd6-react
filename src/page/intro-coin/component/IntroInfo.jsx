  ...
  return (
    <>
      <div class="section">
        ...
        <p>
          Coin là điểm thưởng tích lũy có được khi học viên giới thiệu khóa học
          cho người mới hoặc tặng thưởng theo từng chương trình khác nhau.
        </p>
        <h3>
        ...
        <p>
          - Có tài khoản học viên mới đăng ký khoá học thành công thông qua link
          giới thiệu
        </p>
        ...
        <p>
          - Quy đổi thành Voucher Tiki hoặc thẻ cào điện thoại (lưu ý: chương
          trình đổi COIN sang voucher Tiki hoặc thẻ cào điện thoại chỉ được áp
      ...
      <div class="section">
        ...
        <p>
          ...
          một số điểm COIN tương ứng tùy từng khóa học (mỗi điểm có giá trị
          tương ứng 1000 VNĐ).
        </p>
        <p>
        ...
        <p>
          ...
          thoại (lưu ý: chương trình đổi COIN sang voucher Tiki hoặc thẻ cào
          điện thoại chỉ được áp dụng 2 lần đối với 1 tài khoản học viên).
        </p>
      </div>
      <div class="section">
        <h2>Học viên được giới thiệu (học viên mới):</h2>
        <p>
          - Là tài khoản học viên chưa tham gia bất kỳ khoá học nào của CFD.
        </p>
        <p>
          - Học viên sẽ được giảm giá khi đăng ký thành công khoá học qua đường
          dẫn giới thiệu.
        </p>
        <p>
          - Số tiền được giảm giá sẽ được hiển thị và được áp dụng khi đăng ký
          trực tuyến tại website của CFD qua link giới thiệu.
        </p>
      </div>
    </>
  );
